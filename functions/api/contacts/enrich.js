...
RULES
1. Public sources only (LinkedIn profile, company site, press, registry).
2. "linkedIn":
   ...
   • URL must start "https://www.linkedin.com/in/" – no posts or /company/ pages.
3. "email":
   • Detect the real pattern for domain "${firmDomain}" (e.g. first.last@).
